 ...
 *  Date: May 16, 2015
 *  Time: 15:51:03
 *  Description: AES(128 bit), Output Feedback Block(in 8 bit) Mode (OFB)
 *****************************************************************************/
#include <cstdio>
#include <iostream>
#include <fstream>
...
void aes_ofb(const void* plain, size_t length, const void* key, const void* IV, void* cipher) {
    uint8_t keys[44 * 4];
...
int main(int argc, char** argv) {
    ...
    aes_ofb(buffer.data(), buffer.length(), key, IV, &cipher[0]);
